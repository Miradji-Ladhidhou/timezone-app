...
CREATE TABLE users (
  ...
  role VARCHAR(20) NOT NULL CHECK (role IN ('employe', 'secretaire', 'admin')),
...
CREATE TABLE heures_supp (
  ...
  user_id INTEGER REFERENCES users(id) ON DELETE CASCADE,
  date DATE NOT NULL, 
  heures_normales INTEGER NOT NULL DEFAULT 420, 
